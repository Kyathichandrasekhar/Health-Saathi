...
export default function ChatBot({ onSendMessage }: ChatBotProps) {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: "Hello! 👋 I'm your Health Assistant. Tell me your symptoms, and I'll suggest possible remedies, food recommendations, and general advice. How can I help you today?",
      sender: 'bot',
      timestamp: new Date(),
    },
  ])
        ...
        <AnimatePresence>
          {messages.map((msg) => (
            ...
            >
              ...
              <div
                className={`max-w-[90%] sm:max-w-[84%] lg:max-w-[80%] ${
                  msg.sender === 'user'
